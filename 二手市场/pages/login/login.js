 ...
 Page({
   ...
   myWebsocketConnect: function() {
     ...
     //连接服务器websocket
     wx.connectSocket({
       url: 'ws://www.ykyschoolsell.cn:8443/schoolsell-war/schoolsell/websocket/' + this.data.userID,
       method: "GET",
       success: function(res) {
         //成功时将isOpen变为true
   ...
   doLogin: function(e) {
     ...
     wx.login({
       success: function(res) {
         ...
         wx.request({
           url: 'https://www.ykyschoolsell.cn:8443/schoolsell-war/schoolsell/wxLogin?code=' + code,
           method: "POST",
   ...
   userRegister: function(userInfo) {
     ...
     wx.request({
       url: 'https://www.ykyschoolsell.cn:8443/schoolsell-war/schoolsell/userRegister?filePath=' + filePath + '&gender=' + gender + '&userName=' + userName,
       method: "GET",
       success: function(res) {
